...
## 5. Migration — Update 1.2

Run the following in the **Supabase SQL Editor** to create the tables and policies required for the Online Invoice tools and Active Projects features:
